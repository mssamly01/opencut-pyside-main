...
class RemoveKeyframeCommand(BaseCommand):
    def __init__(self, clip: object, property_name: str, time_seconds: float) -> None:
        self._clip = clip
    ...
    def execute(self) -> None:
        ...
        if self._after is None:
            raise RuntimeError("RemoveKeyframeCommand state is invalid")
